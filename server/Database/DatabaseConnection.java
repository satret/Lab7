...
public class DatabaseConnection {
    ...
    public ArrayList<Route> getAllRoutes() throws Exception {
        final String q = "SELECT * FROM \"Route\";";
    ...
    public Route getRouteById(Long routeId) throws Exception {
        final String q = "SELECT * FROM \"Route\" WHERE \"Id\" = ?;";
    ...
    public void AddRoute(Route r, String ownerName) throws SQLException {
        final String q = "INSERT INTO \"Route\" (\"Owner\", \"Name\", \"CoordinateX\", \"CoordinateY\", \"Date\", \"FromX\", \"FromY\", \"FromName\", \"ToX\", \"ToY\", \"ToName\", \"Distance\") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    public void deleteAllRoutes(String login) throws SQLException {
        final String q = "DELETE FROM \"Route\" WHERE \"Owner\" = ?;";
    ...
    public void deleteRoute(String login, long routeId) throws SQLException {
        final String q = "DELETE FROM \"Route\" WHERE \"Owner\" = ? AND \"Id\" = ?;";
    ...
    public boolean isOwnedByUser(String login, long routeId) {
        final String q = "SELECT count(*) FROM \"Route\" WHERE \"Owner\" = ? AND \"Id\" = ?;";
        int rows = 0;
        readWriteLock.writeLock().lock();
        try {
    ...
    public void updateRoute(String ownerName, Route r) {
        final String q = "UPDATE \"Route\" SET \"Name\" = ?, \"CoordinateX\" = ?, \"CoordinateY\" = ?, \"FromX\" = ?, \"FromY\" = ?, \"FromName\" = ?, \"ToX\" = ?, \"ToY\" = ?, \"ToName\" = ?, \"Distance\" = ? WHERE \"Owner\" = ? AND \"Id\" = ?;";
